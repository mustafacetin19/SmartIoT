...
> Aşağıdaki yapı, depodaki **gerçek klasör isimleri** ile güncellenmiştir.
...
│   └── Web_Service_Documentation.pdf            # Web Servis dökümanı (PDF)
...
- **Web Servis Dokümanı (PDF):**  
  [Docs/Web_Service_Documentation.pdf](Docs/Web_Service_Documentation.pdf)  
...
### Backend **örnek** ayar dosyası (repoda tutulur)
