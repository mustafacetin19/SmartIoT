...
export default function DeviceSelectionPage() {
  ...
  const [devices, setDevices] = useState([]);   // atanmış + atanmamış user_device kayıtları
  ...
  // Etiket: sadece devices tablosundaki isim/model
      ...
      {loading ? (
        ...
        <div className="card center">
          ...
          <div className="quicklinks">
            <button className="btn action" onClick={() => navigate("/my-devices/new")}>+ Create device</button>
            <button className="btn action" onClick={() => navigate("/rooms/new")}>+ Create room</button>
            <button className="btn action" onClick={loadAll}>↻ Refresh</button>
          </div>
        </div>
      )}
    </div>
